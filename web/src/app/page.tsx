  ...
  return (
    <div className="space-y-6">
      ...
      <p className="max-w-2xl text-stone-600">
        Yonder monitors recreation.gov and emails you the moment a site opens for your
        dates — a specific site, or any site at a campground. Plus a free dispersed-camping
        map and reminders for booking windows and permit lotteries, so you&apos;re ready when
        reservations drop.
      </p>
      <ul className="max-w-2xl list-disc space-y-1 pl-5 text-stone-700">
        ...
        <li>Free dispersed-camping map: legal forest roads plus community-rated spots</li>
      </ul>
